...
exports.run = async (bot, message, args) => {
  ...
  .addField("» **Botun Sahibi**", " <@607867218839207961>")
  ...
  .addField("**» Destek Sunucusu**", " [Sunucumuza Katıl](https://discord.gg/WtxXZaZ)", )
  .addField("**» Voteleme sayfası**", "[Vote](https://the-discord-bots.glitch.me/view/617440836803756185)", )
